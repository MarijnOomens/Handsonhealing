...
if ( month >= 3 && month <= 5 ) {
    promotionText.innerHTML = "Voor u is nu het heerlijke lente voorjaar arrangement in de aanbieding. Klik voor een uitgebreide beschrijving van deze behandeling hieronder.";
    seizoensAanbiedingButton.href = "lente-voorjaar-arrangement.html";
}
else if(month >= 6 && month <= 9) {
    promotionText.innerHTML = "Voor u is nu het heerlijke zomer arrangement in de aanbieding. Klik voor een uitgebreide beschrijving van deze behandeling hieronder.";
