...
if (month >= 3 && month <= 5) {
    ...
    promotionText.innerHTML = "Voor u is nu het heerlijke najaar winter arrangement in de aanbieding. Normaal €72,00, nu €68,00. Klik voor een uitgebreide beschrijving van deze behandeling hieronder.";
